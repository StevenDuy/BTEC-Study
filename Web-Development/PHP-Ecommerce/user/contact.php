            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        <a href="/pages/faq.php" class="list-group-item list-group-item-action border-0 px-0">
                            <i class="fas fa-chevron-right me-2 text-muted"></i>
                            Frequently Asked Questions
                        </a>
                        <a href="/pages/shipping.php" class="list-group-item list-group-item-action border-0 px-0">
                            <i class="fas fa-chevron-right me-2 text-muted"></i>
                            Shipping Information
                        </a>
                        <a href="/pages/returns.php" class="list-group-item list-group-item-action border-0 px-0">
                            <i class="fas fa-chevron-right me-2 text-muted"></i>
                            Returns & Refunds
                        </a>
                        <a href="/pages/privacy.php" class="list-group-item list-group-item-action border-0 px-0">
                            <i class="fas fa-chevron-right me-2 text-muted"></i>
                            Privacy Policy
                        </a>
                        <a href="/pages/terms.php" class="list-group-item list-group-item-action border-0 px-0">
                            <i class="fas fa-chevron-right me-2 text-muted"></i>
                            Terms of Service
                        </a>
                    </div>
