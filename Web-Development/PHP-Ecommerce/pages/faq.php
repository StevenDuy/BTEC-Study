            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        <a href="/pages/contact.php" class="list-group-item list-group-item-action border-0 px-0">
                            <i class="fas fa-envelope me-2 text-primary"></i>Contact Support
                        </a>
                        <a href="/auth/register.php" class="list-group-item list-group-item-action border-0 px-0">
                            <i class="fas fa-user-plus me-2 text-success"></i>Create Account
                        </a>
                        <a href="/user/products.php" class="list-group-item list-group-item-action border-0 px-0">
                            <i class="fas fa-shopping-bag me-2 text-info"></i>Browse Products
                        </a>
                        <a href="/pages/about.php" class="list-group-item list-group-item-action border-0 px-0">
