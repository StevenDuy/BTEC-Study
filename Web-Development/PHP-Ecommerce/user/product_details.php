...
// requireRole('user'); // Allow guest access
        ...
        <div class="col-lg-6">
            <div class="product-gallery">
                ...
                <div class="main-image mb-3">
                    <img src="/assets/images/products/<?php echo $product['main_image_url']; ?>"
                        ...
                        <div class="row">
                            ...
                            <div class="col-3 mb-2">
                                <img src="/assets/images/products/<?php echo $product['main_image_url']; ?>"
                                    ...
                                    data-image="/assets/images/products/<?php echo $product['main_image_url']; ?>"
                            ...
                            <?php foreach ($productImages as $image): ?>
                                <div class="col-3 mb-2">
                                    <img src="/assets/images/products/<?php echo $image['url']; ?>"
                                        class="img-fluid rounded thumbnail-img"
                                        data-image="/assets/images/products/<?php echo $image['url']; ?>"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <div class="quantity-controls">
                                    ...
                                    <input type="number" class="form-control quantity-input text-center" id="quantity"
                ...
                <?php foreach ($relatedProducts as $relatedProduct): ?>
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card product-card h-100">
                            <img src="/assets/images/products/<?php echo $relatedProduct['main_image_url']; ?>"
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted small">by <?php echo htmlspecialchars($relatedProduct['seller_name']); ?>
                                </p>
