...
<div class="container-fluid px-0">
    ...
    <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <?php foreach ($featuredProducts as $index => $product): ?>
            <div class="carousel-item <?php echo $index === 0 ? 'active' : ''; ?>" onclick="$('#heroCarousel').carousel('next')" style="cursor: pointer;">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6 text-center">
                                <img src="/assets/images/products/<?php echo $product['main_image_url']; ?>" 
                                     ...
                                     class="img-fluid shadow" style="max-height: 400px; border-radius: 0;">
                            </div>
                        </div>
                    </div>
                </div>
