...
<div class="container">
    ...
    <div class="row mb-5">
        ...
        <div class="col-lg-6 order-lg-1">
            <img src="/assets/images/mission.jpg" alt="Our Mission" class="img-fluid rounded shadow"
    ...
    <div class="row mb-5">
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card text-center">
                <div class="card-body">
                    <img src="/assets/images/team-1.jpg" alt="Team Member" class="rounded-circle mb-3" 
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card text-center">
                <div class="card-body">
                    <img src="/assets/images/team-2.jpg" alt="Team Member" class="rounded-circle mb-3" 
                         style="width: 100px; height: 100px; object-fit: cover;"
                         onerror="this.src='data:image/svg+xml;base64,'">
                    <h5>Sarah Johnson</h5>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card text-center">
                <div class="card-body">
                    <img src="/assets/images/team-3.jpg" alt="Team Member" class="rounded-circle mb-3" 
                         style="width: 100px; height: 100px; object-fit: cover;"
                         onerror="this.src='data:image/svg+xml;base64,'">
                    <h5>Mike Davis</h5>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card text-center">
                <div class="card-body">
                    <img src="/assets/images/team-4.jpg" alt="Team Member" class="rounded-circle mb-3" 
                         style="width: 100px; height: 100px; object-fit: cover;"
                         onerror="this.src='data:image/svg+xml;base64,'">
                    <h5>Emily Chen</h5>
            ...
            <div class="card">
                <div class="card-body text-center py-5">
                    ...
                    <div class="mt-4">
                        ...
                        <?php else: ?>
                        <a href="/<?php echo getUserRole(); ?>/index.php" class="btn btn-primary btn-lg">
